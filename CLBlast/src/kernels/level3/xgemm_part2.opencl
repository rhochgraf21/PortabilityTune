...
R"(#define STORERESULTS2 StoreResults
#define STORERESULTS CONCATENATE(STORERESULTS2, PARAMS)
#define MULTIPLYADDVECTOR2 MultiplyAddVector
#define MULTIPLYADDVECTOR CONCATENATE(MULTIPLYADDVECTOR2, PARAMS)
