...
R"(#define TRANSPOSEMATRIX2 TransposeMatrix
#define TRANSPOSEMATRIX CONCATENATE(TRANSPOSEMATRIX2, PARAMS)
#define _TRANSPOSEMATRIX2 _TransposeMatrix
#define _TRANSPOSEMATRIX CONCATENATE(_TRANSPOSEMATRIX2, PARAMS)
#define TRANSPOSEPADMATRIX2 TransposePadMatrix
#define TRANSPOSEPADMATRIX CONCATENATE(TRANSPOSEPADMATRIX2, PARAMS)
#define _TRANSPOSEPADMATRIX2 _TransposePadMatrix
#define _TRANSPOSEPADMATRIX CONCATENATE(_TRANSPOSEPADMATRIX2, PARAMS)
#define TRANSPOSEMATRIXBATCHED2 TransposeMatrixBatched
#define TRANSPOSEMATRIXBATCHED CONCATENATE(TRANSPOSEMATRIXBATCHED2, PARAMS)
#define TRANSPOSEPADMATRIXBATCHED2 TransposePadMatrixBatched
#define TRANSPOSEPADMATRIXBATCHED CONCATENATE(TRANSPOSEPADMATRIXBATCHED2, PARAMS)
#define TRANSPOSEMATRIXSTRIDEDBATCHED2 TransposeMatrixStridedBatched
#define TRANSPOSEMATRIXSTRIDEDBATCHED CONCATENATE(TRANSPOSEMATRIXSTRIDEDBATCHED2, PARAMS)
#define TRANSPOSEPADMATRIXSTRIDEDBATCHED2 TransposePadMatrixStridedBatched
#define TRANSPOSEPADMATRIXSTRIDEDBATCHED CONCATENATE(TRANSPOSEPADMATRIXSTRIDEDBATCHED2, PARAMS)
