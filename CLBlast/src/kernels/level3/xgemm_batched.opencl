...
R"(#define XGEMMBATCHED2 XgemmBatched
#define XGEMMBATCHED CONCATENATE(XGEMMBATCHED2, PARAMS)
#define XGEMMSTRIDEDBATCHED2 XgemmStridedBatched
#define XGEMMSTRIDEDBATCHED CONCATENATE(XGEMMSTRIDEDBATCHED2, PARAMS)
