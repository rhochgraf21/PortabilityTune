...
R"(#define XGEMMBODY2 XgemmBody
#define XGEMMBODY CONCATENATE(XGEMMBODY2, PARAMS)
#define CLBLAST_SUB_GROUP_SHUFFLE2 clblast_sub_group_shuffle
#define CLBLAST_SUB_GROUP_SHUFFLE CONCATENATE(CLBLAST_SUB_GROUP_SHUFFLE2, PARAMS)
#define CLBLAST_GET_SUB_GROUP_LOCAL_ID2 clblast_get_sub_group_local_id
#define CLBLAST_GET_SUB_GROUP_LOCAL_ID CONCATENATE(CLBLAST_GET_SUB_GROUP_LOCAL_ID2, PARAMS)
