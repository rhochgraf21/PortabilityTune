...
R"(#define HERMUPPERTOSQUARED2 HermUpperToSquared
#define HERMUPPERTOSQUARED CONCATENATE(HERMUPPERTOSQUARED2, PARAMS)
#define HERMLOWERTOSQUARED2 HermLowerToSquared
#define HERMLOWERTOSQUARED CONCATENATE(HERMLOWERTOSQUARED2, PARAMS)
