...
R"(#define XGEMMBATCHED2 XGEMMBATCHED##PARAMS
#define XGEMMSTRIDEDBATCHED2 XGEMMSTRIDEDBATCHED##PARAMS
#define XGEMMBATCHED22 XGEMMBATCHED2##PARAMS
#define XGEMMSTRIDEDBATCHED22 XGEMMSTRIDEDBATCHED2##PARAMS
#define XGEMMSTRIDEDBATCHED2 XGEMMSTRIDEDBATCHED##PARAMS
#define XGEMMBATCHED2 XGEMMBATCHED##PARAMS
...
#define XGEMMBATCHED2 XGEMMBATCHED##PARAMS
#define XGEMMSTRIDEDBATCHED2 XGEMMSTRIDEDBATCHED##PARAMS
#define XGEMMBATCHED2 CONCATENATE(XGEMMBATCHED,PARAMS)
#define XGEMMSTRIDEDBATCHED2 CONCATENATE(XGEMMSTRIDEDBATCHED,PARAMS)
#define XGEMMBATCHED2 CONCATENATE(XGEMMBATCHED,PARAMS)
#define XGEMMSTRIDEDBATCHED2 CONCATENATE(XGEMMSTRIDEDBATCHED,PARAMS)
// =================================================================================================
...
#endif
void #define XGEMMBATCHED XGEMMBATCHED##PARAMS
#define XGEMMBATCHED XGEMMBATCHED##PARAMS
XGEMMBATCHED2(const int kSizeM, const int kSizeN, const int kSizeK,
  ...
  #if SA == 1 && SB == 1
    XGEMMBODY2(kSizeM, kSizeN, kSizeK, agm_, bgm_, cgm_, alpha, beta, alm, blm);
  #elif SA == 1
    XGEMMBODY2(kSizeM, kSizeN, kSizeK, agm_, bgm_, cgm_, alpha, beta, alm);
  #elif SB == 1
    XGEMMBODY2(kSizeM, kSizeN, kSizeK, agm_, bgm_, cgm_, alpha, beta, blm);
  #else
    XGEMMBODY2(kSizeM, kSizeN, kSizeK, agm_, bgm_, cgm_, alpha, beta);
  #endif
}
#endif
// =================================================================================================
  ...
  __kernel __attribute__((reqd_work_group_size(MDIMC, NDIMC, 1)))
#endif
void #define XGEMMSTRIDEDBATCHED XGEMMSTRIDEDBATCHED##PARAMS
#define XGEMMSTRIDEDBATCHED XGEMMSTRIDEDBATCHED##PARAMS
XGEMMSTRIDEDBATCHED2(const int kSizeM, const int kSizeN, const int kSizeK,
