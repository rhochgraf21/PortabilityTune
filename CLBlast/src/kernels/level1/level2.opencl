...
R"(#define LOADVECTOR2 LOADVECTOR##PARAMS
#define MATRIXUPDATE22 MATRIXUPDATE2##PARAMS
#define LOADVECTOR22 LOADVECTOR2##PARAMS
#define MATRIXUPDATE2 MATRIXUPDATE##PARAMS
#define MATRIXUPDATE222 MATRIXUPDATE22##PARAMS
...
#define MATRIXUPDAT2 MATRIXUPDAT##PARAMS
#define MATRIXUPDATE22 MATRIXUPDATE2##PARAMS
#define LOADVECTOR2 CONCATENATE(LOADVECTOR,PARAMS)
#define MATRIXUPDATE22 CONCATENATE(MATRIXUPDATE2,PARAMS)
#define LOADVECTOR2 CONCATENATE(LOADVECTOR,PARAMS)
#define MATRIXUPDAT2 CONCATENATE(MATRIXUPDAT,PARAMS)
#define MATRIXUPDATE22 CONCATENATE(MATRIXUPDATE2,PARAMS)
// =================================================================================================
...
INLINE_FUNC real #define LOADVECTOR LOADVECTOR##PARAMS
#define LOADVECTOR LOADVECTOR##PARAMS
LOADVECTOR2(const int id, const int max,
...
INLINE_FUNC void #define MATRIXUPDATE MATRIXUPDATE##PARAMS
#define MATRIXUPDATE MATRIXUPDATE##PARAMS
MATRIXUPDATE(const int id1, const int id2, const int max1, const int max2,
...
INLINE_FUNC void #define MATRIXUPDATE2 MATRIXUPDATE2##PARAMS
#define MATRIXUPDATE2 MATRIXUPDATE2##PARAMS
MATRIXUPDATE22(const int id1, const int id2, const int max1, const int max2,
                               __global real* agm, const int a_offset, const int a_ld,
