...
R"(#define XIM2COL2 XIM2COL##PARAMS
#define XIM2COLKERNELFLIP2 XIM2COLKERNELFLIP##PARAMS
#define XIM2COLKERNELNORMAL2 XIM2COLKERNELNORMAL##PARAMS
#define XIM2COL22 XIM2COL2##PARAMS
#define XIM2COLKERNELFLIP22 XIM2COLKERNELFLIP2##PARAMS
#define XIM2COLKERNELNORMAL22 XIM2COLKERNELNORMAL2##PARAMS
#define XIM2COLKERNELNORMAL2 XIM2COLKERNELNORMAL##PARAMS
#define XIM2COLKERNELFLIP2 XIM2COLKERNELFLIP##PARAMS
#define XIM2COL2 XIM2COL##PARAMS
...
#define XIM2COLKERNELFLIP2 XIM2COLKERNELFLIP##PARAMS
#define XIM2COLKERNELNORMAL2 XIM2COLKERNELNORMAL##PARAMS
#define XIM2COL2 CONCATENATE(XIM2COL,PARAMS)
#define XIM2COLKERNELFLIP2 CONCATENATE(XIM2COLKERNELFLIP,PARAMS)
#define XIM2COLKERNELNORMAL2 CONCATENATE(XIM2COLKERNELNORMAL,PARAMS)
#define XIM2COL2 CONCATENATE(XIM2COL,PARAMS)
#define XIM2COLKERNELFLIP2 CONCATENATE(XIM2COLKERNELFLIP,PARAMS)
#define XIM2COLKERNELNORMAL2 CONCATENATE(XIM2COLKERNELNORMAL,PARAMS)
...
INLINE_FUNC void #define XIM2COL XIM2COL##PARAMS
#define XIM2COL XIM2COL##PARAMS
XIM2COL2(const int input_h, const int input_w, const int channels,
  ...
  // Thread IDs
  const int w_id = GET_GLOBAL_ID2(0); // image width, max 'output_w'
  const int h_id = ((int)GET_GLOBAL_ID2(1)) % output_h; // image height, max 'output_h'
  const int c_id = ((int)GET_GLOBAL_ID2(1)) / output_h; // input channels
...
#endif
void #define XIM2COLKERNELFLIP XIM2COLKERNELFLIP##PARAMS
#define XIM2COLKERNELFLIP XIM2COLKERNELFLIP##PARAMS
XIM2COLKERNELFLIP2(const int input_h, const int input_w, const int channels,
                       const int output_h, const int output_w,
                       const int kernel_h, const int kernel_w,
                       const int pad_h, const int pad_w,
                       const int stride_h, const int stride_w,
  ...
  XIM2COL2(input_h, input_w, channels, output_h, output_w, kernel_h, kernel_w,
...
// Normal version of the Xim2col kernel (for cross-correlation)
  ...
  __kernel __attribute__((reqd_work_group_size(COPY_DIMX, COPY_DIMY, 1)))
#endif
void #define XIM2COLKERNELNORMAL XIM2COLKERNELNORMAL##PARAMS
#define XIM2COLKERNELNORMAL XIM2COLKERNELNORMAL##PARAMS
XIM2COLKERNELNORMAL2(const int input_h, const int input_w, const int channels,
                         const int output_h, const int output_w,
                         const int kernel_h, const int kernel_w,
                         const int pad_h, const int pad_w,
                         const int stride_h, const int stride_w,
