...
R"(#define GLOBALTOPRIVATECHECKEDIMAGE2 GLOBALTOPRIVATECHECKEDIMAGE##PARAMS
#define GLOBALTOLOCALCHECKEDIMAGE2 GLOBALTOLOCALCHECKEDIMAGE##PARAMS
#define GLOBALTOPRIVATECHECKEDIMAGE22 GLOBALTOPRIVATECHECKEDIMAGE2##PARAMS
#define GLOBALTOLOCALCHECKEDIMAGE22 GLOBALTOLOCALCHECKEDIMAGE2##PARAMS
...
#define GLOBALTOLOCALCHECKEDIMAGE2 GLOBALTOLOCALCHECKEDIMAGE##PARAMS
#define GLOBALTOPRIVATECHECKEDIMAGE2 CONCATENATE(GLOBALTOPRIVATECHECKEDIMAGE,PARAMS)
#define GLOBALTOLOCALCHECKEDIMAGE2 CONCATENATE(GLOBALTOLOCALCHECKEDIMAGE,PARAMS)
#define GLOBALTOPRIVATECHECKEDIMAGE2 CONCATENATE(GLOBALTOPRIVATECHECKEDIMAGE,PARAMS)
#define GLOBALTOLOCALCHECKEDIMAGE2 CONCATENATE(GLOBALTOLOCALCHECKEDIMAGE,PARAMS)
// =================================================================================================
...
INLINE_FUNC real #define GLOBALTOPRIVATECHECKEDIMAGE GLOBALTOPRIVATECHECKEDIMAGE##PARAMS
#define GLOBALTOPRIVATECHECKEDIMAGE GLOBALTOPRIVATECHECKEDIMAGE##PARAMS
GLOBALTOPRIVATECHECKEDIMAGE2(const __global real* restrict imagegm, const int image_offset_batch,
...
// loading the image input tensor. This includes a bounds check.
INLINE_FUNC real #define GLOBALTOLOCALCHECKEDIMAGE GLOBALTOLOCALCHECKEDIMAGE##PARAMS
#define GLOBALTOLOCALCHECKEDIMAGE GLOBALTOLOCALCHECKEDIMAGE##PARAMS
GLOBALTOLOCALCHECKEDIMAGE2(const __global real* restrict imagegm, LOCAL_PTR real* alm,
