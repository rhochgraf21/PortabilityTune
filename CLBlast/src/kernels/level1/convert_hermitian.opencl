...
R"(#define HERMLOWERTOSQUARED2 HERMLOWERTOSQUARED##PARAMS
#define HERMUPPERTOSQUARED2 HERMUPPERTOSQUARED##PARAMS
#define HERMLOWERTOSQUARED22 HERMLOWERTOSQUARED2##PARAMS
#define HERMUPPERTOSQUARED22 HERMUPPERTOSQUARED2##PARAMS
#define HERMUPPERTOSQUARED2 HERMUPPERTOSQUARED##PARAMS
#define HERMLOWERTOSQUARED2 HERMLOWERTOSQUARED##PARAMS
...
#define HERMLOWERTOSQUARED2 HERMLOWERTOSQUARED##PARAMS
#define HERMUPPERTOSQUARED2 HERMUPPERTOSQUARED##PARAMS
#define HERMLOWERTOSQUARED2 CONCATENATE(HERMLOWERTOSQUARED,PARAMS)
#define HERMUPPERTOSQUARED2 CONCATENATE(HERMUPPERTOSQUARED,PARAMS)
#define HERMLOWERTOSQUARED2 CONCATENATE(HERMLOWERTOSQUARED,PARAMS)
#define HERMUPPERTOSQUARED2 CONCATENATE(HERMUPPERTOSQUARED,PARAMS)
// =================================================================================================
...
#endif
void #define HERMLOWERTOSQUARED HERMLOWERTOSQUARED##PARAMS
#define HERMLOWERTOSQUARED HERMLOWERTOSQUARED##PARAMS
HERMLOWERTOSQUARED2(const int src_dim,
...
// Same as above, but now the matrix' data is stored in the upper-triangle
  ...
  __kernel __attribute__((reqd_work_group_size(PAD_DIMX, PAD_DIMY, 1)))
#endif
void #define HERMUPPERTOSQUARED HERMUPPERTOSQUARED##PARAMS
#define HERMUPPERTOSQUARED HERMUPPERTOSQUARED##PARAMS
HERMUPPERTOSQUARED2(const int src_dim,
                        const int src_ld, const int src_offset,
                        __global const real* restrict src,
                        const int dest_dim,
                        const int dest_ld, const int dest_offset,
