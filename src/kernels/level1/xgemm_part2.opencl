...
R"(#define MULTIPLYADDVECTOR2 MULTIPLYADDVECTOR##PARAMS
#define STORERESULTS2 STORERESULTS##PARAMS
#define MULTIPLYADDVECTOR22 MULTIPLYADDVECTOR2##PARAMS
#define STORERESULTS22 STORERESULTS2##PARAMS
#define STORERESULTS2 STORERESULTS##PARAMS
#define MULTIPLYADDVECTOR2 MultiplyAddVector##PARAMS
...
#define MULTIPLYADDVECTOR2 MULTIPLYADDVECTOR##PARAMS
#define STORERESULTS2 STORERESULTS##PARAMS
#define MULTIPLYADDVECTOR2 CONCATENATE(MULTIPLYADDVECTOR,PARAMS)
#define STORERESULTS2 CONCATENATE(STORERESULTS,PARAMS)
#define MULTIPLYADDVECTOR2 CONCATENATE(MULTIPLYADDVECTOR,PARAMS)
#define STORERESULTS2 CONCATENATE(STORERESULTS,PARAMS)
// The vectorised multiply-add function
INLINE_FUNC realM #define MULTIPLYADDVECTOR MULTIPLYADDVECTOR##PARAMS
#define MULTIPLYADDVECTOR MULTIPLYADDVECTOR##PARAMS
MULTIPLYADDVECTOR2(realM cvec, const realM avec, const real bval) {
  #if USE_VECTOR_MAD == 1
    cvec += avec * bval;
  #else
    #if VWM == 1
...
INLINE_FUNC void #define STORERESULTS STORERESULTS##PARAMS
#define STORERESULTS STORERESULTS##PARAMS
STORERESULTS2(__global realM* cgm, realM c_value, const int _mi, const int _ni,
  ...
  #endif
  #if STRN == 0
    int ng = _ni + GET_LOCAL_ID2(1)*NWI;
  #elif STRN == 1
    int ng = _ni%VWN + GET_LOCAL_ID2(1)*VWN + (_ni/VWN)*VWN*NDIMC;
  #endif
  int idm = mg + GETGROUPID02() * (MWG/VWM);
  int idn = ng + GETGROUPID12() * NWG;
