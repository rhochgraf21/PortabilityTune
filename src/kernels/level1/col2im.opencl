...
R"(#define GRID_CEIL2 GRID_CEIL##PARAMS
#define XCOL2IM2 XCOL2IM##PARAMS
#define XCOL2IMKERNELFLIP2 XCOL2IMKERNELFLIP##PARAMS
#define XCOL2IMKERNELNORMAL2 XCOL2IMKERNELNORMAL##PARAMS
#define GRID_CEIL22 GRID_CEIL2##PARAMS
#define XCOL2IM22 XCOL2IM2##PARAMS
#define XCOL2IMKERNELFLIP22 XCOL2IMKERNELFLIP2##PARAMS
#define XCOL2IMKERNELNORMAL22 XCOL2IMKERNELNORMAL2##PARAMS
#define XCOL2IMKERNELNORMAL2 XCOL2IMKERNELNORMAL##PARAMS
#define XCOL2IMKERNELFLIP2 XCOL2IMKERNELFLIP##PARAMS
#define XCOL2IM2 XCOL2IM##PARAMS
#define GRID_CEIL2 GRID_CEIL##PARAMS
...
#define XCOL2IMKERNELFLIP2 XCOL2IMKERNELFLIP##PARAMS
#define XCOL2IMKERNELNORMAL2 XCOL2IMKERNELNORMAL##PARAMS
#define GRID_CEIL2 CONCATENATE(GRID_CEIL,PARAMS)
#define XCOL2IM2 CONCATENATE(XCOL2IM,PARAMS)
#define XCOL2IMKERNELFLIP2 CONCATENATE(XCOL2IMKERNELFLIP,PARAMS)
#define XCOL2IMKERNELNORMAL2 CONCATENATE(XCOL2IMKERNELNORMAL,PARAMS)
#define GRID_CEIL2 CONCATENATE(GRID_CEIL,PARAMS)
#define XCOL2IM2 CONCATENATE(XCOL2IM,PARAMS)
#define XCOL2IMKERNELFLIP2 CONCATENATE(XCOL2IMKERNELFLIP,PARAMS)
#define XCOL2IMKERNELNORMAL2 CONCATENATE(XCOL2IMKERNELNORMAL,PARAMS)
...
#endif
// =================================================================================================
inline int #define GRID_CEIL GRID_CEIL##PARAMS
#define GRID_CEIL GRID_CEIL##PARAMS
GRID_CEIL2(const int x, const int step) {
  return x > 0 ? ((x - 1) / step + 1) * step : x / step * step;
}
// Main body of the kernel
INLINE_FUNC void #define XCOL2IM XCOL2IM##PARAMS
#define XCOL2IM XCOL2IM##PARAMS
XCOL2IM2(const int input_h, const int input_w, const int channels,
  ...
  // Thread IDs
  const int gcd_scale_w = GET_GLOBAL_ID2(0) + (pad_w - 1) / gcd_w + 1;
  const int gcd_scale_h = ((int) GET_GLOBAL_ID2(1)) % input_h_scaled + (pad_h - 1) / gcd_h + 1;
  const int c_id = ((int) GET_GLOBAL_ID2(1)) / input_h_scaled;
  ...
  const int th_begin = GRID_CEIL2(max(-stride_bez_h * gcd_scale_h * stride_h,
  ...
  const int tw_begin = GRID_CEIL2(max(-stride_bez_w * gcd_scale_w * stride_w,
...
#endif
void #define XCOL2IMKERNELFLIP XCOL2IMKERNELFLIP##PARAMS
#define XCOL2IMKERNELFLIP XCOL2IMKERNELFLIP##PARAMS
XCOL2IMKERNELFLIP2(const int input_h, const int input_w, const int channels,
                       const int output_h, const int output_w,
                       const int kernel_h, const int kernel_w,
                       const int pad_h, const int pad_w,
                       const int stride_h, const int stride_w,
  ...
  XCOL2IM2(input_h, input_w, channels, output_h, output_w, kernel_h, kernel_w,
...
// Normal version of the Xcol2im kernel (for cross-correlation)
  ...
  __kernel __attribute__((reqd_work_group_size(COPY_DIMX, COPY_DIMY, 1)))
#endif
void #define XCOL2IMKERNELNORMAL XCOL2IMKERNELNORMAL##PARAMS
#define XCOL2IMKERNELNORMAL XCOL2IMKERNELNORMAL##PARAMS
XCOL2IMKERNELNORMAL2(const int input_h, const int input_w, const int channels,
                         const int output_h, const int output_w,
                         const int kernel_h, const int kernel_w,
                         const int pad_h, const int pad_w,
                         const int stride_h, const int stride_w,
