...
R"(#define TRIALOWERTOSQUARED2 TRIALOWERTOSQUARED##PARAMS
#define TRIAUPPERTOSQUARED2 TRIAUPPERTOSQUARED##PARAMS
#define TRIALOWERTOSQUARED22 TRIALOWERTOSQUARED2##PARAMS
#define TRIAUPPERTOSQUARED22 TRIAUPPERTOSQUARED2##PARAMS
#define TRIAUPPERTOSQUARED2 TRIAUPPERTOSQUARED##PARAMS
#define TRIALOWERTOSQUARED2 TRIALOWERTOSQUARED##PARAMS
...
#define TRIALOWERTOSQUARED2 TRIALOWERTOSQUARED##PARAMS
#define TRIAUPPERTOSQUARED2 TRIAUPPERTOSQUARED##PARAMS
#define TRIALOWERTOSQUARED2 CONCATENATE(TRIALOWERTOSQUARED,PARAMS)
#define TRIAUPPERTOSQUARED2 CONCATENATE(TRIAUPPERTOSQUARED,PARAMS)
#define TRIALOWERTOSQUARED2 CONCATENATE(TRIALOWERTOSQUARED,PARAMS)
#define TRIAUPPERTOSQUARED2 CONCATENATE(TRIAUPPERTOSQUARED,PARAMS)
// =================================================================================================
...
#endif
void #define TRIALOWERTOSQUARED TRIALOWERTOSQUARED##PARAMS
#define TRIALOWERTOSQUARED TRIALOWERTOSQUARED##PARAMS
TRIALOWERTOSQUARED2(const int src_dim,
...
// Same as above, but now the matrix' data is stored in the upper-triangle
  ...
  __kernel __attribute__((reqd_work_group_size(PAD_DIMX, PAD_DIMY, 1)))
#endif
void #define TRIAUPPERTOSQUARED TRIAUPPERTOSQUARED##PARAMS
#define TRIAUPPERTOSQUARED TRIAUPPERTOSQUARED##PARAMS
TRIAUPPERTOSQUARED2(const int src_dim,
                        const int src_ld, const int src_offset,
                        __global const real* restrict src,
                        const int dest_dim,
                        const int dest_ld, const int dest_offset,
