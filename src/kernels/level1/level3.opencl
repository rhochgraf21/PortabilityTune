...
R"(#define FILLMATRIX2 FILLMATRIX##PARAMS
#define FILLMATRIX22 FILLMATRIX2##PARAMS
#define FILLMATRIX2 FILLMATRIX##PARAMS
#define FILLMATRIX FILLMATRIX##PARAMS
#define FILLMATRIX FILLMATRIX##PARAMS
#define FILLMATRIX FILLMATRIX##PARAMS
#define FILLMATRIX2 FILLMATRIX##PARAMS
#define FILLMATRIX2 CONCATENATE(FILLMATRIX,PARAMS)
#define FILLMATRIX2 CONCATENATE(FILLMATRIX,PARAMS)
// =================================================================================================
...
__kernel
void #define FILLMATRIX FILLMATRIX##PARAMS
#define FILLMATRIX FILLMATRIX##PARAMS
FILLMATRIX2(const int m, const int n, const int ld, const int offset,
  ...
  const int id_two = GET_GLOBAL_ID2(1);
