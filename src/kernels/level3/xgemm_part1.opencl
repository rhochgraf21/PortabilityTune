...
R"(#define GLOBALTOLOCALA2 GlobalToLocalA
#define GLOBALTOLOCALA CONCATENATE(GLOBALTOLOCALA2, PARAMS)
#define GLOBALTOLOCALB2 GlobalToLocalB
#define GLOBALTOLOCALB CONCATENATE(GLOBALTOLOCALB2, PARAMS)
#define LOCALTOPRIVATEB2 LocalToPrivateB
#define LOCALTOPRIVATEB CONCATENATE(LOCALTOPRIVATEB2, PARAMS)
#define LOCALTOPRIVATEA2 LocalToPrivateA
#define LOCALTOPRIVATEA CONCATENATE(LOCALTOPRIVATEA2, PARAMS)
#define INITACCREGISTERS2 InitAccRegisters
#define INITACCREGISTERS CONCATENATE(INITACCREGISTERS2, PARAMS)
#define GLOBALTOPRIVATEA2 GlobalToPrivateA
#define GLOBALTOPRIVATEA CONCATENATE(GLOBALTOPRIVATEA2, PARAMS)
#define GLOBALTOPRIVATEB2 GlobalToPrivateB
#define GLOBALTOPRIVATEB CONCATENATE(GLOBALTOPRIVATEB2, PARAMS)
#define GLOBALTOPRIVATEB2D2 GlobalToPrivateB2D
#define GLOBALTOPRIVATEB2D CONCATENATE(GLOBALTOPRIVATEB2D2, PARAMS)
#define GLOBALTOPRIVATEA2D2 GlobalToPrivateA2D
#define GLOBALTOPRIVATEA2D CONCATENATE(GLOBALTOPRIVATEA2D2, PARAMS)
