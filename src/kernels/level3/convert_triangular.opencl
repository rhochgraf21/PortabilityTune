...
R"(#define TRIALOWERTOSQUARED2 TriaLowerToSquared
#define TRIALOWERTOSQUARED CONCATENATE(TRIALOWERTOSQUARED2, PARAMS)
#define TRIAUPPERTOSQUARED2 TriaUpperToSquared
#define TRIAUPPERTOSQUARED CONCATENATE(TRIAUPPERTOSQUARED2, PARAMS)
