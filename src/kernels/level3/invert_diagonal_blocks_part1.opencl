...
R"(#define TRIPLEMATMUL2 TripleMatMul
#define TRIPLEMATMUL CONCATENATE(TRIPLEMATMUL2, PARAMS)
#define TRIPLEMATMULPART12 TripleMatMulPart1
#define TRIPLEMATMULPART1 CONCATENATE(TRIPLEMATMULPART12, PARAMS)
#define TRIPLEMATMULPART22 TripleMatMulPart2
#define TRIPLEMATMULPART2 CONCATENATE(TRIPLEMATMULPART22, PARAMS)
#define INVERTDIAGONALBLOCK2 InvertDiagonalBlock
#define INVERTDIAGONALBLOCK CONCATENATE(INVERTDIAGONALBLOCK2, PARAMS)
