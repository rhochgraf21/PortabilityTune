...
R"(#define STORERESULTSDIRECT2 StoreResultsDirect
#define STORERESULTSDIRECT CONCATENATE(STORERESULTSDIRECT2, PARAMS)
#define STORERESULTSCHECKED2 StoreResultsChecked
#define STORERESULTSCHECKED CONCATENATE(STORERESULTSCHECKED2, PARAMS)
#define LOCALTOPRIVATEDIRECTA2 LocalToPrivateDirectA
#define LOCALTOPRIVATEDIRECTA CONCATENATE(LOCALTOPRIVATEDIRECTA2, PARAMS)
#define LOCALTOPRIVATEDIRECTB2 LocalToPrivateDirectB
#define LOCALTOPRIVATEDIRECTB CONCATENATE(LOCALTOPRIVATEDIRECTB2, PARAMS)
#define GLOBALTOPRIVATEDIRECTA2 GlobalToPrivateDirectA
#define GLOBALTOPRIVATEDIRECTA CONCATENATE(GLOBALTOPRIVATEDIRECTA2, PARAMS)
#define GLOBALTOPRIVATEDIRECTB2 GlobalToPrivateDirectB
#define GLOBALTOPRIVATEDIRECTB CONCATENATE(GLOBALTOPRIVATEDIRECTB2, PARAMS)
#define GLOBALTOPRIVATECHECKEDB2 GlobalToPrivateCheckedB
#define GLOBALTOPRIVATECHECKEDB CONCATENATE(GLOBALTOPRIVATECHECKEDB2, PARAMS)
#define GLOBALTOPRIVATECHECKEDA2 GlobalToPrivateCheckedA
#define GLOBALTOPRIVATECHECKEDA CONCATENATE(GLOBALTOPRIVATECHECKEDA2, PARAMS)
