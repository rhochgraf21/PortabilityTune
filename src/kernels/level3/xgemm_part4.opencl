...
R"(#define XGEMM2 Xgemm
#define XGEMM CONCATENATE(XGEMM2, PARAMS)
#define XGEMMUPPER2 XgemmUpper
#define XGEMMUPPER CONCATENATE(XGEMMUPPER2, PARAMS)
#define XGEMMLOWER2 XgemmLower
#define XGEMMLOWER CONCATENATE(XGEMMLOWER2, PARAMS)
