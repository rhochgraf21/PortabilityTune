...
R"(#define GLOBALTOLOCALDIRECTB2 GlobalToLocalDirectB
#define GLOBALTOLOCALDIRECTB CONCATENATE(GLOBALTOLOCALDIRECTB2, PARAMS)
#define GLOBALTOLOCALSCALARA2 GlobalToLocalScalarA
#define GLOBALTOLOCALSCALARA CONCATENATE(GLOBALTOLOCALSCALARA2, PARAMS)
#define GLOBALTOLOCALDIRECTA2 GlobalToLocalDirectA
#define GLOBALTOLOCALDIRECTA CONCATENATE(GLOBALTOLOCALDIRECTA2, PARAMS)
#define GLOBALTOLOCALSCALARB2 GlobalToLocalScalarB
#define GLOBALTOLOCALSCALARB CONCATENATE(GLOBALTOLOCALSCALARB2, PARAMS)
#define GLOBALTOLOCALCHECKEDA2 GlobalToLocalCheckedA
#define GLOBALTOLOCALCHECKEDA CONCATENATE(GLOBALTOLOCALCHECKEDA2, PARAMS)
#define GLOBALTOLOCALCHECKEDB2 GlobalToLocalCheckedB
#define GLOBALTOLOCALCHECKEDB CONCATENATE(GLOBALTOLOCALCHECKEDB2, PARAMS)
